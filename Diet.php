    ...
    <div class="dashboard-container">
        ...
        <main class="main-dashboard">
            <div class="config-summary">
                <p> To refine the diet summary, please fill in the following fields. Leave the fields blank to show all details.
            ...
            <!-- A container to display the diet summary. -->
            ...
            $(document).ready(function() {
                ...
                $('#summary-form').submit(function(e) {
                    ...
                    $.ajax({
                        ...
                        url: 'getDietSummary.php', // Send the POST data to this file.
                        data: formData,
                        success: function(response) {
                            // If the request was successful, display the response in the response container
                            $('#diet-summary').html(response);
                        },
                        error: function() {
                            // Handle any errors during the AJAX request
                            $('#diet-summary').html('The POST request failed. Please refresh and try again.');
                        }
                    });
                });
            });
