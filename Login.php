            ...
            <div class="login-form">
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                    ...
                    if (!$conn) {
                        ...
                        $inputUsername = htmlspecialchars($_POST['username']); // convert <> to HTML entities to prevent XXS.
                        ...
                        if (!$result) {
                            ...
                            if ($matchCount > 0) {
                                ...
                                $_SESSION['username'] = htmlspecialchars($_POST['username']); // store the username within the session.
